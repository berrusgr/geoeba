...
export const TREE_TOOL_GROUPS: TreeToolGroup[] = [
  ...
  // 2. Düzenleme Araçları
  {
    ...
    defaultExpanded: true,
    tools: [
      { id: 'select', name: 'Seç ve Taşı', description: 'Noktaları veya nesneleri seçip sürükleyin.', icon: <MousePointer className="w-4 h-4" /> },
  ...
  // 3. Ölçme Araçları
  {
    ...
    tools: [
      { id: 'measure_distance', name: 'Uzunluk Ölç (cm)', description: 'Mesafe ve uzunluk ölçün.', icon: <Ruler className="w-4 h-4 -rotate-45" /> },
      { id: 'unit_measure', name: 'Birimle Ölç (br)', description: 'Birim karelerle ölçüm yapın.', icon: <GeometryToolIcon kind="grid" /> },
      { id: 'measure_angle', name: 'Açıölçer', description: 'Açı ölçümü yapın.', icon: <GeometryToolIcon kind="protractor" /> },
      { id: 'angle', name: 'Açı Oluştur', description: '3 nokta ile açı oluşturun.', icon: <GeometryToolIcon kind="angle" /> },
      { id: 'measure_area', name: 'Alanı Bul', description: 'Kapalı şeklin alanını hesaplayın.', icon: <GeometryToolIcon kind="area" /> },
      { id: 'measure_perimeter', name: 'Çevre Hesapla', description: 'Şeklin çevre uzunluğunu hesaplayın.', icon: <GeometryToolIcon kind="perimeter" /> },
      { id: 'measure_slope', name: 'Eğim Ölç', description: 'İki noktaya tıklayın; aradaki doğrunun eğimini gösterir.', icon: <TrendingUp className="w-4 h-4" /> },
      { id: 'trig_ratios', name: 'Trig. Oranlar', description: 'Açının trigonometrik oranlarını ve dik üçgen oranlarını gösterir.', icon: <Triangle className="w-4 h-4" /> },
  ...
  // 4. Çember Araçları
  {
    ...
    tools: [
      ...
      { id: 'arc', name: 'Yay', description: 'Merkez, başlangıç ve bitiş noktasına tıklayın; saat yönünün tersine yay çizilir.', icon: <GeometryToolIcon kind="arc" /> },
      { id: 'sector', name: 'Daire Dilimi', description: 'Yay ile aynı üç tıklama, ama içi dolu pasta dilimi çizilir.', icon: <PieChart className="w-4 h-4" /> },
      { id: 'ellipse', name: 'Elips', description: 'Kutuya içten teğet elips çizilir.', icon: <GeometryToolIcon kind="ellipse" /> },
    ],
  },
  ...
  // 6. Cebir & Fonksiyon
  {
    ...
    tools: [
      ...
      { id: 'slider', name: 'Sürgü', description: 'a, b gibi parametreler için sürgü ekleyin.', icon: <Sliders className="w-4 h-4" /> },
    ],
  },
  ...
  // 7. İnşa Araçları
  {
    ...
    tools: [
      ...
      { id: 'perpendicular', name: 'Dik Doğru', description: 'İki nokta doğrultuyu, üçüncü nokta doğrunun geçtiği yeri belirler.', icon: <Plus className="w-4 h-4" /> },
  ...
  // 8. Dönüşüm Araçları
  {
    ...
    defaultExpanded: false,
    tools: [
      { id: 'rotate', name: 'Şekli Döndür', description: 'Şekli bir merkez etrafında döndürün.', icon: <RotateCw className="w-4 h-4" /> },
      { id: 'translate', name: 'Öteleme', description: 'Öteleme vektörüyle şekli taşıyın.', icon: <MoveRight className="w-4 h-4" /> },
      { id: 'reflect', name: 'Yansıt', description: 'Doğruya göre simetri / yansıma.', icon: <FlipHorizontal className="w-4 h-4" /> },
      { id: 'symmetry', name: 'Simetri Keşfet', description: 'Simetri eksenlerini keşfedin.', icon: <Sparkles className="w-4 h-4" /> },
    ],
  },
  ...
  // 9. Etkileşim Araçları
  {
    ...
    tools: [
      ...
      { id: 'button', name: 'Düğme', description: 'Seçili nesneleri çalıştıran düğme ekleyin.', icon: <MousePointerClick className="w-4 h-4" /> },
  ...
  // 10. Kesir & Medya
  {
    ...
    tools: [
      ...
      { id: 'text', name: 'Yazı Ekle', description: 'Tuvale metin kutusu ekleyin.', icon: <Type className="w-4 h-4" /> },
    ],
  },
];
